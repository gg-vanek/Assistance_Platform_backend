...
urlpatterns = [
    ...
    path('<int:reviewerid>/sent_reviews', ReviewList.as_view()),  #
    path('<int:reviewreceiverid>/received_reviews', ReviewList.as_view()),  #
    ...
    path('<str:reviewerusername>/sent_reviews', ReviewList.as_view()),  # отзывы пользователя по юзернейму
    path('<str:reviewreceiverusername>/received_reviews', ReviewList.as_view()),  # отзывы НА пользователя по юзернейму
